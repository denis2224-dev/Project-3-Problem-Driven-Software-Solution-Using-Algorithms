...
import static com.unischeduler.domain.CourseAsserts.*;
...
import com.unischeduler.repository.CourseRepository;
import com.unischeduler.service.CourseService;
import com.unischeduler.service.dto.CourseDTO;
import com.unischeduler.service.mapper.CourseMapper;
...
class CourseResourceIT {
    ...
    public static Course createEntity(EntityManager em) {
        Course course = new Course().code(DEFAULT_CODE).name(DEFAULT_NAME).credits(DEFAULT_CREDITS);
        // Add required entity
    ...
    public static Course createUpdatedEntity(EntityManager em) {
        Course updatedCourse = new Course().code(UPDATED_CODE).name(UPDATED_NAME).credits(UPDATED_CREDITS);
        // Add required entity
        Department department;
        if (TestUtil.findAll(em, Department.class).isEmpty()) {
    ...
    void putExistingCourse() throws Exception {
        ...
        updatedCourse.code(UPDATED_CODE).name(UPDATED_NAME).credits(UPDATED_CREDITS);
    ...
    void fullUpdateCourseWithPatch() throws Exception {
        ...
        partialUpdatedCourse.code(UPDATED_CODE).name(UPDATED_NAME).credits(UPDATED_CREDITS);
