...
import static com.unischeduler.domain.DepartmentAsserts.*;
...
import com.unischeduler.service.DepartmentService;
...
class DepartmentResourceIT {
    ...
    public static Department createEntity(EntityManager em) {
        Department department = new Department().name(DEFAULT_NAME).code(DEFAULT_CODE);
        // Add required entity
        Faculty faculty;
    ...
    public static Department createUpdatedEntity(EntityManager em) {
        Department updatedDepartment = new Department().name(UPDATED_NAME).code(UPDATED_CODE);
        // Add required entity
        Faculty faculty;
        if (TestUtil.findAll(em, Faculty.class).isEmpty()) {
    ...
    void putExistingDepartment() throws Exception {
        ...
        updatedDepartment.name(UPDATED_NAME).code(UPDATED_CODE);
