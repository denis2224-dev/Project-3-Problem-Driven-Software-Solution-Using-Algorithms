...
import { ScheduleConflictDeleteDialog } from './schedule-conflict-delete-dialog';

describe('ScheduleConflict Management Delete Component', () => {
  let comp: ScheduleConflictDeleteDialog;
  let fixture: ComponentFixture<ScheduleConflictDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ScheduleConflictDeleteDialog);
