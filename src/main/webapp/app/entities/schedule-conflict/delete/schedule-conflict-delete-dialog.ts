...
@Component({
  ...
  templateUrl: './schedule-conflict-delete-dialog.html',
  imports: [TranslateDirective, TranslateModule, FormsModule, FontAwesomeModule, AlertError],
})
export class ScheduleConflictDeleteDialog {
  scheduleConflict?: IScheduleConflict;
  ...
  confirmDelete(id: number): void {
    this.scheduleConflictService.delete(id).subscribe(() => {
