...
describe('Room Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Room', () => {
      ...
      service.create(room).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a Room', () => {
      ...
      service.update(room).subscribe(resp => (expectedResult = resp));
    ...
    describe('addRoomToCollectionIfMissing', () => {
      it('should add a Room to an empty array', () => {
        ...
        expect(expectedResult).toEqual([room]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([room, room2]);
      });
