...
import { ProfessorPreferenceDeleteDialog } from './professor-preference-delete-dialog';

describe('ProfessorPreference Management Delete Component', () => {
  let comp: ProfessorPreferenceDeleteDialog;
  let fixture: ComponentFixture<ProfessorPreferenceDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ProfessorPreferenceDeleteDialog);
