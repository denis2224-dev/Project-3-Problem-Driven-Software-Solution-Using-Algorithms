...
import { TimetableEntryDeleteDialog } from './timetable-entry-delete-dialog';

describe('TimetableEntry Management Delete Component', () => {
  let comp: TimetableEntryDeleteDialog;
  let fixture: ComponentFixture<TimetableEntryDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(TimetableEntryDeleteDialog);
