...
import { SolverJobDeleteDialog } from './solver-job-delete-dialog';

describe('SolverJob Management Delete Component', () => {
  let comp: SolverJobDeleteDialog;
  let fixture: ComponentFixture<SolverJobDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(SolverJobDeleteDialog);
