...
import { TimetableVersionDeleteDialog } from './timetable-version-delete-dialog';

describe('TimetableVersion Management Delete Component', () => {
  let comp: TimetableVersionDeleteDialog;
  let fixture: ComponentFixture<TimetableVersionDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(TimetableVersionDeleteDialog);
