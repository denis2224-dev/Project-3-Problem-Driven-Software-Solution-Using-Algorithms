...
import { CourseEventDeleteDialog } from './course-event-delete-dialog';

describe('CourseEvent Management Delete Component', () => {
  let comp: CourseEventDeleteDialog;
  let fixture: ComponentFixture<CourseEventDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CourseEventDeleteDialog);
