...
import { ExamScheduleEntryDeleteDialog } from './exam-schedule-entry-delete-dialog';

describe('ExamScheduleEntry Management Delete Component', () => {
  let comp: ExamScheduleEntryDeleteDialog;
  let fixture: ComponentFixture<ExamScheduleEntryDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ExamScheduleEntryDeleteDialog);
